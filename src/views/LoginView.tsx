    ...
    <div className="min-h-screen bg-brand-bg flex flex-col relative overflow-hidden">
      ...
      <header className="p-8 flex items-center justify-between relative z-10">
        ...
        <nav className="flex items-center gap-8">
          <a href="#" className="text-sm font-medium text-slate-500 hover:text-brand-primary transition-colors">Empresa</a>
          <a href="#" className="text-sm font-medium text-slate-500 hover:text-brand-primary transition-colors">Soluciones</a>
